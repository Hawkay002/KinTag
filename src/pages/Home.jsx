  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans selection:bg-brandGold selection:text-white relative w-full">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4 pointer-events-none">
        <div className={`pointer-events-auto w-full max-w-5xl relative transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${isScrolled ? 'translate-y-0 shadow-[0_8px_32px_0_rgba(0,0,0,0.08)] scale-100' : 'translate-y-2 shadow-none scale-[1.01]'}`}>
          
          {/* Glass Background Elements */}
          <div className="absolute inset-0 rounded-[2.5rem] bg-white/40 backdrop-blur-[20px] border border-white/60 shadow-[inset_0_0_10px_rgba(255,255,255,0.5)] overflow-hidden -z-10">
             {/* Diagonal ambient glass reflection */}
             <div className="absolute -inset-[100%] bg-gradient-to-tr from-transparent via-white/40 to-transparent rotate-45 pointer-events-none"></div>
             {/* Top physical edge rim light */}
             <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white to-transparent opacity-100"></div>
          </div>

          <nav className="relative z-10 px-5 py-3 md:py-4 md:px-8 flex items-center justify-between w-full">
